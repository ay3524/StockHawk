...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    interface StockAdapterOnClickHandler {
        void onClick(String symbol, Double price, Double absoluteChange,
                     Double precentChange, String history, String name,
    ...
    class StockViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int currencyColumn = cursor.getColumnIndex(Contract.Quote.COLUMN_CURRENCY);
            clickHandler.onClick(cursor.getString(symbolColumn),
                    cursor.getDouble(priceColumn),
                    cursor.getDouble(absoluteChangeColumn),
                    cursor.getDouble(percentChangeColumn),
                    cursor.getString(historyColumn),
                    cursor.getString(nameColumn),
                    cursor.getString(stockExchangeColumn),
                    cursor.getString(currencyColumn));
        }
    }
}
